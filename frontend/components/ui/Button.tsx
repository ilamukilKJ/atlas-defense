...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700/60 focus:ring-slate-400",
    danger: "bg-rose-600 hover:bg-rose-500 text-white focus:ring-rose-500 shadow-sm",
    outline: "bg-transparent border border-slate-700 hover:bg-slate-800/60 text-slate-300 focus:ring-slate-500",
